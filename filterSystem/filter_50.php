...
<head>
	...
	<link href="../assets/css/filter/filter50.css" rel="stylesheet" type="text/css"/>
		...
		<section class="section-flip-card">
        	<div class="jumbotron jumbotron-fluid d-flex align-items-center">
            	<div class="container-fluid content">
					...
					<form action="./addYes_50.php" method="post" style="display:inline">
                    	<input type="hidden" name="word" value="<?php echo($word);?>" />
                    	<input type="submit" class="btn btn-success" value="Already Know">
                  	</form>
                  	<form action="./addNo_50.php" method="post" style="display:inline">
                    	<input type="hidden" name="word" value="<?php echo($word);?>" />
